...
import './sobre.css'
import scrollRevealConfig from './sobre-reveal'
    ...
    <section className='sobre' id='sobre'>
      ...
      <div className='info'>
        ...
        <div className="card">
          ...
          <p className='p-reveal'>{t("about.about-me")}</p>
